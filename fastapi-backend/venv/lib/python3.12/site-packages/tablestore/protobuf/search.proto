...
message MatchQuery {
    ...
    optional int32 minimum_should_match = 3 [deprecated=true];
...
message BoolQuery {
    ...
    optional int32 minimum_should_match = 5 [deprecated = true];
    optional string new_minimum_should_match = 6;
...
message GroupByGeoGrid {
    optional string field_name = 1;
    optional GeoHashPrecision precision = 2;
...
message SyncStat {
    ...
    optional int64 current_sync_timestamp = 2; // Synchronize progress, refer to TunnelService.
}
